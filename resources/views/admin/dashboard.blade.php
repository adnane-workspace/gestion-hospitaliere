    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white p-8 rounded-[2rem] shadow-premium border border-slate-100 flex items-center gap-6 group hover:border-indigo-100 transition-all">
            ...
            <div>
                ...
                <p class="text-3xl font-black text-slate-800">{{ \App\Models\Patient::count() }}</p>
            </div>
        </div>
        ...
        <div class="bg-white p-8 rounded-[2rem] shadow-premium border border-slate-100 flex items-center gap-6 group hover:border-indigo-100 transition-all">
            ...
            <div>
                ...
                <p class="text-3xl font-black text-slate-800">{{ \App\Models\User::where('role', 'medecin')->where('is_active', true)->count() }}</p>
            </div>
        </div>
        ...
        <div class="bg-white p-8 rounded-[2rem] shadow-premium border border-slate-100 flex items-center gap-6 group hover:border-indigo-100 transition-all">
            ...
            <div>
                ...
                <p class="text-3xl font-black text-slate-800">{{ \App\Models\User::where('role', 'medecin')->where('is_active', false)->count() }}</p>
            </div>
        </div>
    </div>
